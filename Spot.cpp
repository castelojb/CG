...
Vector3 Spot::Iluminacao(Vector3 observer , Vector3 Point_Object , Vector3 Normal_Of_Face , Texture Texture_Object , float polimento){
	...
	Ipix     =(this->Idif(Texture_Object.texture_dif , l ,n)* this->spotlight(this->getPosition(), {0,-1,0},(Point_Object - this->getPosition()),0)) + ( this->Iesp(Texture_Object.texture_esp , r ,v,polimento)  );
